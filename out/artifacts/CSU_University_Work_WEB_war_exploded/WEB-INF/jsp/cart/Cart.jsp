...
<div id="Cart">
	...
	<form action="updateCartQuantities" method="post">
		<table>
			...
			<c:forEach var="cartItem" items="${sessionScope.cart.cartItems}">
				...
				<script src="${pageContext.request.contextPath }/javascript/updateCart.js"></script>
			</c:forEach>
			<tr id="lastTR">
	...
	<c:if test="${sessionScope.cart.numberOfItems > 0}">
		<a class="Button" href="createOrder?itemId=${cartItem.item.itemId}">Proceed to Checkout</a>
	</c:if>
</div>
